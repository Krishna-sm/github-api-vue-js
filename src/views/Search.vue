...
<template>
   <div class="flex justify-center flex-col items-center">
               ...
               <form @submit.prevent="fetchedData" class="my-10 w-[95%] duration-300 transition-all md:w-1/2 mx-auto bg-white flex items-center px-3 rounded-md">
                <input v-model="inputData" type="text" placeholder="Search Any User" class="w-full h-10 py-8 md:py-10 text-gray-900 px-3 focus:outline-none focus:border-none text-2xl rounded-md ">
               <button type="submit" >
